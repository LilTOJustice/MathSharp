namespace MathSharp
{
    ...
    public struct DVec2 : IVec2<DVec2, Degree, Degree, DVec2>, ISwizzlable<DVec2, Degree>, IEquatable<DVec2>
    {
        ...
        /// </summary>
        public DVec2(Degree x, Degree y) { X = x; Y = y; }
        ...
        public DVec3 Cross(in DVec2 rhs) => new DVec3(new Degree(), new Degree(), Cross2d(rhs));

        /// <summary>
        /// Converts a degree vector to a radian vector.
        /// </summary>
        public static implicit operator RVec2(in DVec2 vec) => new RVec2(new Radian(vec.X.Radians), new Radian(vec.Y.Radians));
        ...
        public static DVec2 operator *(in DVec2 lhs, Degree scalar) => IVec2<DVec2, Degree, Degree, DVec2>.IMul(lhs, scalar);
        ...
        public static DVec2 operator /(in DVec2 lhs, Degree scalar) => IVec2<DVec2, Degree, Degree, DVec2>.IDiv(lhs, scalar);
