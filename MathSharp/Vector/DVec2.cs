namespace MathSharp
{
    ...
    /// </summary>
    public struct DVec2 : IVec2<DVec2, Degree, double, FVec2>, ISwizzlable<DVec2, Degree>, IEquatable<DVec2>
    {
        ...
        public Degree[] Components => IVec2<DVec2, Degree, double, FVec2>.IComponents(this);
        ...
        {
            get => IVec2<DVec2, Degree, double, FVec2>.IIndexerGet(this, i);
            set => IVec2<DVec2, Degree, double, FVec2>.IIndexerSet(ref this, i, value);
        }

        /// <inheritdoc cref="ISwizzlable{TSelf, TBase}.this[string]"/>
        public Degree[] this[string swizzle]
        {
            get => IVec2<DVec2, Degree, double, FVec2>.ISwizzleGet(this, swizzle);
            set => IVec2<DVec2, Degree, double, FVec2>.ISwizzleSet(ref this, swizzle, value);
        }

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.ISwizzleToSelf"/>
        public static implicit operator DVec2(Degree[] swizzle) => IVec2<DVec2, Degree, double, FVec2>.ISwizzleToSelf(swizzle);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.ISelfToSwizzle"/>
        public static implicit operator Degree[](in DVec2 vec) => IVec2<DVec2, Degree, double, FVec2>.ISelfToSwizzle(vec);
        ...
        public FVec2 Rotate(Radian angle) => IVec2<DVec2, Degree, double, FVec2>.IRotate(this, angle);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.Mag2"/>
        public Degree Mag2() => IVec2<DVec2, Degree, double, FVec2>.IMag2(this);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.Mag"/>
        public double Mag() => IVec2<DVec2, Degree, double, FVec2>.IMag(this);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.Dot"/>
        public Degree Dot(in DVec2 other) => IVec2<DVec2, Degree, double, FVec2>.IDot(this, other);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.Cross2d"/>
        public Degree Cross2d(in DVec2 rhs) => IVec2<DVec2, Degree, double, FVec2>.ICross2d(this, rhs);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.Norm()"/>
        public FVec2 Norm() => IVec2<DVec2, Degree, double, FVec2>.INorm(this);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.Norm()"/>
        public FVec2 Norm(out double mag)
        {
            mag = Mag();
            return new FVec2(X.Degrees / mag, Y.Degrees / mag);
        }
        ...
        public static DVec2 operator +(in DVec2 lhs, in DVec2 rhs) => IVec2<DVec2, Degree, double, FVec2>.IAdd(lhs, rhs);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.ISub"/>
        public static DVec2 operator -(in DVec2 lhs, in DVec2 rhs) => IVec2<DVec2, Degree, double, FVec2>.ISub(lhs, rhs);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.IMul(in TSelf, in TSelf)"/>
        public static DVec2 operator *(in DVec2 lhs, in DVec2 rhs) => IVec2<DVec2, Degree, double, FVec2>.IMul(lhs, rhs);
        ...
        public static DVec2 operator /(in DVec2 lhs, in DVec2 rhs) => IVec2<DVec2, Degree, double, FVec2>.IDiv(lhs, rhs);
        ...
        public bool Equals(DVec2 other) => IVec2<DVec2, Degree, double, FVec2>.IEquals(this, other);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.IEquals(in TSelf, in object?)"/>
        public override bool Equals(object? obj) => IVec2<DVec2, Degree, double, FVec2>.IEquals(this, obj);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.IGetHashCode"/>
        public override int GetHashCode() => IVec2<DVec2, Degree, double, FVec2>.IGetHashCode(this);

        /// <inheritdoc cref="IVec2{TSelf, TBase, TFloat, TVFloat}.IToString"/>
        public override string ToString() => IVec2<DVec2, Degree, double, FVec2>.IToString(this);
    }
}
