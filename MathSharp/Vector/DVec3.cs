namespace MathSharp
{
    ...
    /// </summary>
    public struct DVec3 : IVec3<DVec3, Degree, double, FVec3>, ISwizzlable<DVec3, Degree>, IEquatable<DVec3>
    {
        ...
        public Degree[] Components => IVec3<DVec3, Degree, double, FVec3>.IComponents(this);
        ...
        public Degree this[int i] {
            get => IVec3<DVec3, Degree, double, FVec3>.IIndexerGet(this, i);
            set => IVec3<DVec3, Degree, double, FVec3>.IIndexerSet(ref this, i, value);
        }

        /// <inheritdoc cref="ISwizzlable{TSelf, TBase}.this[string]"/>
        public Degree[] this[string swizzle]
        {
            get => IVec3<DVec3, Degree, double, FVec3>.ISwizzleGet(this, swizzle);
            set => IVec3<DVec3, Degree, double, FVec3>.ISwizzleSet(ref this, swizzle, value);
        }

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.ISwizzleToSelf"/>
        public static implicit operator DVec3(Degree[] swizzler) => IVec3<DVec3, Degree, double, FVec3>.ISwizzleToSelf(swizzler);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.ISelfToSwizzle"/>
        public static implicit operator Degree[](in DVec3 vec) => IVec3<DVec3, Degree, double, FVec3>.ISelfToSwizzle(vec);
        ...
        public FVec3 Rotate(in RVec3 angle) => IVec3<DVec3, Degree, double, FVec3>.IRotate(this, angle);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.Mag2"/>
        public Degree Mag2() => IVec3<DVec3, Degree, double, FVec3>.IMag2(this);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.Mag"/>
        public double Mag() => IVec3<DVec3, Degree, double, FVec3>.IMag(this);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.Dot"/>
        public Degree Dot(in DVec3 other) => IVec3<DVec3, Degree, double, FVec3>.IDot(this, other);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.Cross"/>
        public DVec3 Cross(in DVec3 rhs) => IVec3<DVec3, Degree, double, FVec3>.ICross(this, rhs);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.Norm()"/>
        public FVec3 Norm() => IVec3<DVec3, Degree, double, FVec3>.INorm(this);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.Norm()"/>
        public FVec3 Norm(out double mag)
        {
            mag = Mag();
            return new FVec3(X.Degrees / mag, Y.Degrees / mag, Z.Degrees / mag);
        }
        ...
        public static DVec3 operator +(in DVec3 lhs, in DVec3 rhs) => IVec3<DVec3, Degree, double, FVec3>.IAdd(lhs, rhs);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.ISub"/>
        public static DVec3 operator -(in DVec3 lhs, in DVec3 rhs) => IVec3<DVec3, Degree, double, FVec3>.ISub(lhs, rhs);
        ...
        public bool Equals(DVec3 other) => IVec3<DVec3, Degree, double, FVec3>.IEquals(this, other);

        /// <inheritdoc cref="object.Equals(object?)"/>
        public override bool Equals(object? obj) => IVec3<DVec3, Degree, double, FVec3>.IEquals(this, obj);

        /// <inheritdoc cref="object.GetHashCode"/>
        public override int GetHashCode() => IVec3<DVec3, Degree, double, FVec3>.IGetHashCode(this);

        /// <inheritdoc cref="IVec3{TSelf, TBase, TFloat, TVFloat}.IToString"/>
        public override string ToString() => IVec3<DVec3, Degree, double, FVec3>.IToString(this);
    }
}
